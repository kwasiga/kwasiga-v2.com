...
const staticLines = [
  ...
  BLANK,
  [cyan('$ '), teal('cat'), tx(' courses.txt')],
  [fn('Linear Algebra'), tx('  ·  '), fn('Differential Equations'), tx('  ·  '), fn('Calculus I/II/III')],
  [fn('Physics I/II'), tx('  ·  '), fn('Chemistry'), tx('  ·  '), fn('Data Structures')],
  [fn('Algorithms'), tx('  ·  '), fn('Computer Organization')],
  BLANK,
